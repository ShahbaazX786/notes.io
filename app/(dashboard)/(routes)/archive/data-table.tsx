...
export function DataTable<TData, TValue>({
  ...
  const [columnVisibility, setColumnVisibility] = useState<VisibilityState>({}); // for hiding
  const [globalFilter, setGlobalFilter] = useState(""); // for searching / filtering in all columns
